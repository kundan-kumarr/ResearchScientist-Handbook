...
# Time-Series Analysis and Models {#sec-trendtest}
...
Both $n\to \infty$ and $k_n\to \infty$; $\mathrm{MSE}\to$ constant. 
Hence, we can consider $\sqrt{n}(\mathrm{MST}-\mathrm{MSE})$ instead of $\sqrt{n}(F_n-1)$.
