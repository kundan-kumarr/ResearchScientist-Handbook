...
To fully experience this course, we recommend you to have the following knowledge prior to starting the course.
    ...
    Intermediate knowledge of deep learning techniques. You can describe backpropagation, and have seen multiple examples of neural network architectures (like a CNN for image classification).
    You have seen or worked with a deep learning framework like TensorFlow, Keras, or PyTorch.
    Fundamentals of reinforcement learning. You are familiar with the reinforcement learning algorithms such as Monte Carlo and Q-learning.
...
Resources
    ...
    Read this article(opens in a new tab) if you'd like to learn more about how the Japanese robot company Fanuc uses deep RL to learn new tasks.
    This robot(opens in a new tab) at UC Berkeley also uses deep RL to learn new skills.
    Learn how Amazon is using deep RL(opens in a new tab) to make their warehouses more efficient.

https://www.technologyreview.com/2016/03/18/161519/this-factory-robot-learns-a-new-job-overnight/

https://www.cnet.com/science/robot-learns-via-trial-and-error-like-a-human/

https://teamrework.medium.com/deep-learning-in-production-warehousing-with-amazon-robotics-571e69fea721
...
To master advanced robotics software engineering skills, and gain hands-on experience developing solutions that solve challenging robotics and AI problems, check out the Robotics Software Engineer Nanodegree Program(opens in a new tab)!
...
##  Deep Q-Networks
The role of value optimization and DQNs in deep reinforcement learning.
