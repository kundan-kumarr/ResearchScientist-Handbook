...
# Neural Network {#sec-neural-network}
...
1. Implement forward propagation and compute loss functions manually.
1. Derive and implement the backpropagation algorithm for weight updates.
1. Train and test the model on sample data to evaluate accuracy and generalization.
1. For validation and efficiency, compare manual implementation with high-level frameworks (e.g., TensorFlow, PyTorch).
...
* Online Tutorial: “Neural Networks from Scratch in Python” by Harrison Kinsley & Daniel Kukieła (2020)
