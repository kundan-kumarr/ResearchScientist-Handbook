...
This module aims to introduce the complete workflow of modern machine learning data pipelines, emphasizing four key stages in nearly all ML systems: data handling, model selection and optimization, evaluation, and deployment. Mastering these components enables effective design, training, and deployment of models across various applications.

**Objectives**

1. Prepare and transform data by scaling, encoding, handling missing values, detecting leakage, and managing imbalances. 
1. Select and optimize machine learning models, tune hyperparameters, regularize them, and use AIC/BIC for comparison. 
1. Evaluate model performance with metrics, validation techniques, and error analysis for generalization.
1. Deploy and maintain ML models in production, focusing on versioning, serving, drift detection, and continuous improvement.

**Reading materials**

* Introduction to Machine Learning with Python — A. Müller & S. Guido
* Hands-On Machine Learning with Scikit-Learn, Keras & TensorFlow — Aurélien Géron
* Pattern Recognition and Machine Learning — C. Bishop (Ch. 1–4 on modeling & inference)
* Elements of Statistical Learning — Hastie, Tibshirani, Friedman (Ch. 2–7 on supervised learning)
* Designing Machine Learning Systems — Chip Huyen (Sections on data pipelines, evaluation, deployment)
* Selected documentation: scikit-learn (preprocessing, metrics, model selection), MLflow, TensorFlow Lite, ONNX Runtime


## Data Handling
The data handling stage converts raw, unstructured data into suitable inputs for machine learning. This involves preprocessing, statistical analysis, and decisions on missing values, feature rescaling, and training splits. The following subsections cover the main components.

### Feature Engineering
Feature engineering creates meaningful predictors from raw data using mathematical transformations, categorical encodings, discretization, and text vectorization.
Feature engineering (scaling, one-hot encoding, bucketing, transformations)
