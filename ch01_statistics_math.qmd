...
# Statistics & Mathematics {#sec-regression}
...
Formally, $F_{\mathrm{obs}} = \mathrm{MSR/MSE}$ (the ratio of the mean square due to regression and the mean square due to stochastic errors).

We reject $H_{0}$ when $F_{\mathrm{obs}}$ is too large relative to a cut-off point determined by the degrees of freedom of the $F$-distribution. 
